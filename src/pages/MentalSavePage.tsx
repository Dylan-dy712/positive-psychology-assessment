    ...
    <div className="page-container pb-24">
      ...
      <div className="bg-white rounded-t-[24px] min-h-[calc(100vh-120px)] pt-6">
        ...
        <div className="flex items-center justify-between px-4 mb-6">
          ...
          <img src="/positive-psychology-assessment/assets/pengpengbeibei.png" alt="PengPengBeiBei" className="w-24 h-24 object-contain flex-shrink-0" />
        </div>
          ...
          <div className="p-5 bg-[#6B55FF] rounded-xl shadow-md">
            <div className="flex flex-col">
              <div className="flex items-center gap-2 mb-3">
                <img src="/positive-psychology-assessment/assets/xinlihuobi.svg" alt="心理货币" className="w-6 h-6" />
        ...
        <div className="px-4 mb-6">
          ...
          <div className="bg-[#D1EAFF] rounded-xl p-4">
            <div className="grid grid-cols-3 gap-4">
              ...
              >
                <img src="/positive-psychology-assessment/assets/rijitb.png" alt="感恩日记" className="w-14 h-14 object-contain" />
              ...
              <button 
                ...
                className="flex flex-col items-center gap-2"
              >
                <img src="/positive-psychology-assessment/assets/xltb.png" alt="心流时刻" className="w-14 h-14 object-contain" />
              ...
              <button 
                ...
                className="flex flex-col items-center gap-2"
              >
                <img src="/positive-psychology-assessment/assets/xwmhtb.png" alt="希望盲盒" className="w-14 h-14 object-contain" />
          ...
          <div className="bg-[#FEFFDE] rounded-xl p-4">
            <div className="grid grid-cols-3 gap-4">
              <button 
                ...
                className="flex flex-col items-center gap-2"
              >
                <img src="/positive-psychology-assessment/assets/jltc.png" alt="焦虑弹窗" className="w-14 h-14 object-contain" />
              ...
              <button 
                ...
                className="flex flex-col items-center gap-2"
              >
                <img src="/positive-psychology-assessment/assets/kkxxl.png" alt="夸夸消消乐" className="w-14 h-14 object-contain" />
              ...
              <button 
                ...
                className="flex flex-col items-center gap-2"
              >
                <img src="/positive-psychology-assessment/assets/xyls.png" alt="心渊猎手" className="w-14 h-14 object-contain" />
              ...
              <button 
                ...
                className="flex flex-col items-center gap-2"
              >
                <img src="/positive-psychology-assessment/assets/xyzp.png" alt="心愈战牌" className="w-14 h-14 object-contain" />
              ...
              <button 
                ...
                className="flex flex-col items-center gap-2"
              >
                <img src="/positive-psychology-assessment/assets/ylgy.png" alt="愈了个愈" className="w-14 h-14 object-contain" />
              ...
              <button 
                ...
                className="flex flex-col items-center gap-2"
              >
                <img src="/positive-psychology-assessment/assets/xqgk.png" alt="心晴刮卡" className="w-14 h-14 object-contain" />
