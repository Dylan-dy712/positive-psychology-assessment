...
export const HopeBlindBoxSuccessPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-6">
        <h2 className="text-xl font-bold text-center mb-4">叮咚！好运掉落！你的专属「希望盲盒」已成功开启！✨</h2>
        ...
        <p className="text-red-600 font-bold text-center mb-6">完成后可以获得45个心理货币</p>
