...
export const HeartCardsGamePage = () => {
  ...
  useEffect(() => {
    ...
    const handleMessage = (event: MessageEvent) => {
      if (event.data === 'heartCardsCompleted') {
        handleGameComplete();
      }
    };
  ...
  const handleGameComplete = () => {
    ...
    if (!dailyRewards.heartCards) {
      updateCoinBalance(10, '完成心愈战牌小游戏');
      updateDailyRewards('heartCards', true);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-between p-4 bg-[#FFA203] text-white">
        ...
        <h1 className="text-xl font-bold">心愈战牌</h1>
      ...
      <div className="w-full" style={{ height: 'calc(100vh - 64px)' }}>
        <iframe
          ref={iframeRef}
          src="/positive-psychology-assessment/heart-cards-game.html"
