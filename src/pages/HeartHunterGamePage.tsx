...
export const HeartHunterGamePage = () => {
  ...
  useEffect(() => {
    ...
    const handleMessage = (event: MessageEvent) => {
      if (event.data === 'heartHunterCompleted') {
        handleGameComplete();
      }
    };
  ...
  const handleGameComplete = () => {
    ...
    if (!dailyRewards.heartHunter) {
      updateCoinBalance(10, '完成心渊猎手小游戏');
      updateDailyRewards('heartHunter', true);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-between p-4 bg-[#FFA203] text-white">
        ...
        <h1 className="text-xl font-bold">心渊猎手</h1>
      ...
      <div className="w-full" style={{ height: 'calc(100vh - 64px)' }}>
        <iframe
          ref={iframeRef}
          src="/positive-psychology-assessment/heart-hunter-game.html"
